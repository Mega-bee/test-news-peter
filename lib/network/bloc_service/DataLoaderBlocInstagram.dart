...
import '../../instgram_module/model/insta_model.dart';
import '../../news_by_date/model/newsByDate.dart';

enum RequestType { get, post, put }

class GlobalEventInsta extends Equatable {
  @override
  // TODO: implement props
  List<Object> get props => [];
}

class FetchData extends GlobalEventInsta {
  final String? url;
...
class InstagramBloc extends Bloc<GlobalEventInsta, GlobalState> {
  InstagramBloc(initialState) : super(initialState);
...
//       return null;
  ...
  @override
  Stream<GlobalState> mapEventToState(GlobalEventInsta event) async* {
    ...
    if (event is FetchData) {
      ...
      try {
        ...
        if (response != null) {
          ...
          InstaModel? webServiceResponse;
          try {
            webServiceResponse =
                InstaModel.fromJson(json.decode(response.body));
